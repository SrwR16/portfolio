...
const Header: React.FC = () => {
  ...
  return (
    <header className="terminal-header pointer-events-none fixed left-0 right-0 z-50 flex h-14 origin-top mt-8">
      <div className="fixed inset-x-0 top-0 h-24 w-full bg-background to-transparent backdrop-blur-lg [-webkit-mask-image:linear-gradient(to_bottom,black,transparent)]"></div>
