...
const Projects = () => {
  const projectsInfos = [
    {
      ...
      photo: profileapp,
      description:
        'a "create your card" system, where the user can create profiles to display infos about himself, linking social medias and showing his favorite song and GIF. The design is fully customizable, allow the creator to change colors, fonts and positions of items on screen.',
  ...
  const minorProjects = [
    ...
    },
    {
      title: "word.zzz",
      description:
        "a game where you try to guess the word based on your previous attempts, like wordle or term.ooo. It allows user to play non-stop, instead of daily playing like others.",
